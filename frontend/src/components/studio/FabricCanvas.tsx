...
export function FabricCanvas() {
  ...
  const GARMENT_SHAPES: Record<string, string> = {
    tshirt:
      "polygon(30% 10%, 40% 15%, 60% 15%, 70% 10%, 95% 25%, 85% 45%, 75% 35%, 70% 95%, 30% 95%, 25% 35%, 15% 45%, 5% 25%)",
    hoodie:
      "polygon(35% 0%, 65% 0%, 70% 15%, 95% 30%, 85% 55%, 75% 40%, 70% 95%, 30% 95%, 25% 40%, 15% 55%, 5% 30%, 30% 15%)",
    crewneck:
      "polygon(35% 10%, 65% 10%, 75% 15%, 95% 30%, 85% 50%, 75% 38%, 70% 95%, 30% 95%, 25% 38%, 15% 50%, 5% 30%, 25% 15%)",
    jacket:
      "polygon(35% 5%, 50% 15%, 65% 5%, 75% 15%, 95% 35%, 80% 50%, 70% 35%, 70% 95%, 30% 95%, 30% 35%, 20% 50%, 5% 35%, 25% 15%)",
    pants:
      "polygon(25% 5%, 75% 5%, 85% 95%, 55% 95%, 50% 35%, 45% 95%, 15% 95%)",
    sneakers:
      "polygon(10% 40%, 30% 20%, 50% 20%, 70% 40%, 90% 70%, 90% 90%, 10% 90%)",
    totebag:
      "polygon(25% 10%, 35% 10%, 35% 25%, 65% 25%, 65% 10%, 75% 10%, 75% 30%, 95% 30%, 95% 95%, 5% 95%, 5% 30%, 25% 30%)",
    ...
    <div className="flex items-center justify-center w-full h-full overflow-auto bg-[#111111] relative">
      ...
      <div className="absolute inset-0 flex justify-center items-center pointer-events-none opacity-20">
        <div
          ...
          style={{
            ...
            height: "900px",
            clipPath:
              GARMENT_SHAPES[currentGarment.id] || GARMENT_SHAPES.tshirt,
            backgroundImage:
              "repeating-linear-gradient(45deg, transparent, transparent 10px, rgba(0,229,255,0.2) 10px, rgba(0,229,255,0.2) 20px)",
          }}
        />
      </div>
      ...
      >
        ...
        <div className="absolute -top-6 left-0 right-0 flex justify-between text-[10px] text-[#555] font-mono px-2">
          <span>0cm</span>
          <span className="text-[#00E5FF] font-bold px-2 py-0.5 bg-black/40 rounded-full">
            {currentGarment.printWidth} × {currentGarment.printHeight} (Print
            Safe Zone)
          </span>
        ...
        <div className="absolute -left-8 top-0 bottom-0 flex flex-col justify-between text-[10px] text-[#555] font-mono py-2">
          <span>0cm</span>
          <span className="[writing-mode:vertical-rl] rotate-180 text-[#00E5FF]">
            {currentGarment.printHeight}
          </span>
          <span>&darr;</span>
        </div>
        ...
        <div className="absolute -bottom-8 left-0 right-0 flex items-center justify-between px-2 text-[10px] text-[#555] font-mono">
          ...
          <span>
            {currentGarment.label} — Placement:{" "}
            <span className="text-[#00E5FF] capitalize">
