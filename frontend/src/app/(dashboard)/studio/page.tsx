...
export default function StudioPage() {
  return (
    <div className="flex flex-col h-[85vh] bg-[#0A0A0A] rounded-3xl overflow-hidden border border-slate-200 shadow-sm relative">
      {/* Studio toolbar */}
      <div className="absolute top-0 inset-x-0 z-40 bg-white/95 backdrop-blur-md border-b border-slate-200 px-6 py-2.5 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <span className="text-xs text-slate-500 font-medium">Classic Tee · v1</span>
        </div>
