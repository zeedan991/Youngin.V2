    ...
    <div className="w-full max-w-6xl mx-auto">
      ...
      >
        <div className="flex items-center gap-6">
          <div className="relative">
            <div
              className="w-28 h-28 rounded-full p-[3px] shadow-2xl"
              style={{
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mb-3 flex-wrap">
              ...
              {/* ── Level Badge ── */}
              <span
                className="flex items-center gap-1.5 text-xs font-black uppercase tracking-widest px-3 py-1 rounded-full border"
                style={{
            ...
            {profile.bio && (
              <p
                className="max-w-xl text-sm mb-4 leading-relaxed"
                style={{ color: textMuted }}
              >
                {profile.bio}
              </p>
      ...
      >
        <h2
          ...
          style={{ color: textMain }}
        >
          <Flame className="w-5 h-5" style={{ color: accent }} /> Public
          Portfolio
        </h2>
        ...
        {designs.length === 0 ? (
          ...
          >
            ...
            <p className="font-bold text-lg" style={{ color: textMain }}>
              No Designs Yet
            </p>
            <p className="text-sm">
              This creator hasn't published any designs.
            </p>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {designs.map((design: any) => (
              <div
                key={design.id}
                className="group rounded-3xl overflow-hidden border transition-all hover:scale-[1.02]"
              ...
              >
                <div className="aspect-[4/5] relative bg-slate-900 overflow-hidden">
                  ...
                  <div
                    className="absolute top-3 right-3 text-[10px] font-black px-2.5 py-1 rounded-full uppercase tracking-wider backdrop-blur-md"
                    style={{
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    <h4 className="font-bold text-sm text-white truncate drop-shadow-md">
                      {design.title}
                    </h4>
                  </div>
                </div>
