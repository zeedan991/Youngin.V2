    ...
    <main className="min-h-screen flex items-center justify-center overflow-hidden bg-[#000] relative selection:bg-[#4F46E5] selection:text-white">
      ...
      <div className="absolute inset-0 z-0 bg-[#000]">
        ...
        <div className="absolute bottom-12 left-12 max-w-sm sm:max-w-md hidden md:block opacity-60 mix-blend-screen">
          <h2 className="text-white font-display font-medium text-lg sm:text-xl tracking-[0.3em] mb-3 uppercase">
            Design · Scan · Own
          </h2>
          <p className="text-white/60 font-medium text-xs sm:text-sm leading-relaxed tracking-wide">
            Upload your specifications directly to our global network of master
            tailors. Experience the future of made-to-measure fashion
            architecture.
          </p>
        </div>
      </div>
      ...
      >
        ...
        <div className="text-center mb-8">
          <h1 className="font-display text-3xl font-black text-white tracking-[6px] uppercase mb-3 drop-shadow-lg">
            YOUNGIN
          </h1>
          <p className="text-[#888] text-sm font-medium">
            Access your 3D measurement profile
          </p>
        </div>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 py-3.5 rounded-xl border border-white/[0.08] bg-white/[0.03] text-white text-sm font-bold hover:bg-white/[0.07] transition-all mb-6 disabled:opacity-50"
              >
                {isGoogleLoading ? (
                  <motion.div
                    animate={{ rotate: 360 }}
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="text-[#444] text-xs font-bold tracking-widest uppercase">
                  or
                </span>
                <div className="flex-1 h-px bg-white/[0.06]" />
              </div>
              ...
              <form className="space-y-4" onSubmit={handleSubmit}>
                {mode === "signup" && (
                  <div>
                    <label
                      htmlFor="fullname"
                      className="block text-[10px] text-[#555] font-bold uppercase tracking-[3px] mb-2"
                    >
                      Full Name
                    </label>
                    <input
                ...
                {mode === "signin" && (
                  <div className="text-right">
                    <a
                      href="#"
                      className="text-xs font-bold text-[#555] hover:text-[#4F46E5] transition-colors"
                    >
                      Forgot password?
                    </a>
                  </div>
