      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        ...
        <div className="lg:col-span-3 rounded-2xl border border-white/5 overflow-hidden" style={{ background: "#111118" }}>
          <div className="flex items-center justify-between px-6 py-4 border-b border-white/5">
            <div className="flex items-center gap-2">
              <ClipboardList className="w-4 h-4 text-[#FF4D94]" />
              <h2 className="font-black text-[#F0EBE3] text-sm uppercase tracking-wider">Recent Orders</h2>
            </div>
            <Link href="/tailor/orders" className="text-[10px] font-black text-white/30 hover:text-[#FF4D94] flex items-center gap-1 uppercase tracking-wider transition-colors">
          ...
          <div className="divide-y divide-white/5">
            {orders.slice(0, 4).map((o) => (
              <div key={o.id} className="flex items-center gap-4 px-6 py-4">
                <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-[#FF4D94]/20 to-[#B8005C]/20 flex items-center justify-center shrink-0">
                  <Scissors className="w-4 h-4 text-[#FF4D94]" />
                </div>
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="rounded-2xl border border-white/5 p-5" style={{ background: "#111118" }}>
            <h3 className="font-black text-[#F0EBE3] text-xs uppercase tracking-widest mb-4 flex items-center gap-2"><Users className="w-3.5 h-3.5 text-[#FF4D94]" /> Business Stats</h3>
              ...
              {[
                ...
                <Link key={a.href} href={a.href} className="flex items-center justify-between px-3 py-3 rounded-xl bg-white/3 border border-white/5 hover:border-white/15 hover:bg-white/7 transition-all group">
                  <div className="flex items-center gap-3">
                    <a.icon className="w-3.5 h-3.5 text-[#FF4D94]" />
