    ...
    fetchLiveProfile().then((r) => {
      if (r.success && r.data) {
        ...
        setForm({
          ...
          bio:
            extended.bio ||
            (typeof d.bio === "string" && !d.bio.startsWith("{")
              ? d.bio
              : "") ||
            "",
      ...
      <div className="flex items-start justify-between flex-wrap gap-4">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">
            How clients discover, trust, and contact you.
          </p>
        </div>
          ...
          {editing ? (
            <>
              <button
                ...
                className="px-5 py-2.5 rounded-xl text-xs font-black uppercase tracking-widest text-slate-500 border border-slate-200 hover:border-slate-300 hover:bg-white transition-all shadow-sm bg-white"
              >
                Cancel
              </button>
              <button
            ...
            <button
              ...
              className="flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-black uppercase tracking-widest text-slate-600 border border-slate-200 hover:border-slate-300 hover:bg-white transition-all shadow-sm bg-white"
            >
              Edit Profile
            </button>
          )}
      ...
      <div className="rounded-2xl overflow-hidden border border-slate-200 bg-white shadow-xl shadow-slate-200/50">
        ...
        <div className="px-6 pb-6 -mt-10 flex items-end gap-4 flex-wrap">
          ...
          <div className="flex-1 min-w-0 mb-1">
            <h2 className="text-slate-900 font-black text-xl truncate">
          ...
          <div className="flex gap-2 mb-1 flex-wrap">
            {form.contact_whatsapp && (
              <a
                href={`https://wa.me/${form.contact_whatsapp.replace(/\D/g, "")}`}
                target="_blank"
                rel="noreferrer"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="rounded-2xl border border-slate-200 p-6 space-y-5 bg-white shadow-xl shadow-slate-200/50">
          ...
          <TextArea
            label="Bio / About"
            field="bio"
            placeholder="Tell clients about your craft, style, and experience..."
          />
          <SelectInput
        ...
        <div className="rounded-2xl border border-slate-200 p-6 space-y-5 bg-white shadow-xl shadow-slate-200/50">
          ...
          <SelectInput
            ...
            field="tailor_specialty"
            options={SPECIALTIES}
          />
          <TextInput
            label="Location / City"
            field="tailor_location"
            placeholder="e.g. Lagos, London, New York"
          />
          <TextInput
            label="Starting Price ($)"
            field="tailor_price_from"
            placeholder="50"
            type="number"
          />
          <SelectInput
      ...
      <div className="rounded-2xl border border-slate-200 p-6 bg-white shadow-xl shadow-slate-200/50">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {[
            ...
            <div
              key={s.label}
              className="text-center py-5 rounded-xl bg-slate-50 border border-slate-100 shadow-sm"
            >
